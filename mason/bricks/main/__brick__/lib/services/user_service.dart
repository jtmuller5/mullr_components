...
class UserService with ReactiveServiceMixin {
  ...
  Future<String?> getThumbnailImage({String? userId}) async {
    userId ??= uid!;
    Reference imageRef = FirebaseStorage.instance.ref().child('users').child(userId).child('thumbnails').child('profileImage_200x200.png');
