import 'package:mullr_components/services/settings_service.dart';
...
class CloudMessagingService {
  ...
  Future<void> saveTokenToDatabase(String token) async {
    try {
      await FirebaseFirestore.instance.collection('users').doc(GetIt.instance.get<UserService>().uid).update(
        {
